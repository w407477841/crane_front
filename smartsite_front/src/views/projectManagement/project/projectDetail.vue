                            ...
                            <el-row>
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="项目经纬度" prop="placePoint">
                                        <el-input v-model="formDatas.placePoint" :readonly="true" :disabled="edit" maxlength="100"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item>
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="项目类别" prop="type">
                                        <el-select v-model="formDatas.type" :disabled="edit" placeholder="项目类别" :clearable="true" :filterable="true">
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="项目区域" prop="positions">
                                        <el-cascader :options="positionList" v-model="formDatas.positions" :disabled="edit" :props="positionProps" style="width : 100%" :change-on-select="true"></el-cascader>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="建筑面积(平方米)" prop="buildingSize">
                                        <el-input-number v-model.number="formDatas.buildingSize" :disabled="edit" :min="0" :max="9999999999" :precision="2" :controls="false"></el-input-number>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="施工单位" prop="builders">
                                        <el-cascader :options="builderList" :disabled="edit" v-model="formDatas.builders" :props="builderProps" style="width : 100%" :change-on-select="true"></el-cascader>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                ...
                                <el-col :xs="24" :sm="24" :md="24">
                                    <el-form-item label="项目简介">
                                        <el-input :disabled="edit" type="textarea" v-model="formDatas.introduction" maxlength="50"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                ...
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                    <el-form-item label="联系电话" prop="managerPhone">
                                        <el-input v-model.number="formDatas.managerPhone" :disabled="edit" maxlength="11"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="8" class="itemHeight">
                                ...
                                <el-col :xs="24" :sm="24" :md="24">
                                    <el-form-item label="项目平面图" prop="ichnography">
                                        <upload-image v-model="formDatas.ichnography" :limit="1" :fileList="fileList" :disabled="edit" @data="imageData"></upload-image>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
...
<script>
import {insertPorject,updatePorject,getProjectById,selectArea,selectOrganizationInfo} from '@/views/api/equipmentApi.js';
...
export default {
  ...
  methods: {
      ...
      getProjectById(param).then(res => {
        ...
        if(res.data.ichnography != "") {
          this.$set(this.fileList,0,{
            ...
            url: url + '/fileUpload/filedownload?remotePath=' + res.data.ichnography
          });
        }
      });
    },
    ...
    handleSubmit() {
      ...
      if(this.formDatas.positions != '' && this.formDatas.positions != undefined) {
        this.formDatas.position = this.formDatas.positions[this.formDatas.positions.length-1];
      }
      if(this.formDatas.builders != '' && this.formDatas.builders != undefined) {
        this.formDatas.builder = this.formDatas.builders[this.formDatas.builders.length-1];
      }
    ...
    mapShow : function(isClose) {
      if(!this.formDatas.projectScope) {
        ...
        this.$emit("setShow",{isClose:isClose,sign : "打开地图",projectScope : this.formDatas.projectScope});
      }
    },
    //获取施工单位
    getOrg : function() {
