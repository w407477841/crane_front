...
<template>
    <div class="app-container list-container">
        <div class="container-box condition-box">
            <div class="conditionBar">
                <el-form :inline="true" class="condition-form">
                    <el-form-item>
                        <el-input size="mini" placeholder="版本号" v-model="keyword" clearable
                    ...
                    <topButton :operationPrex="operationPrex" @clickInsert="handleInsert" @clickDelate="handleDelete"
                               check="callTimes=1" :sels="sels"></topButton>
                </el-form>
            </div>
        </div>
                ...
                <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row
                    ...
                    <el-table-column label="操作" width="200px" align="center" fixed="right">
                        <template slot-scope="scope">
                            <settingButton  :operationPrex="operationPrex"
                                            @handleDelete="handleDelete" @handleUpgrade="handleUpgrade"
                                             :row="scope.row"></settingButton>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
        ...
        <detailsDialog v-if="visible" :visible.sync="visible" @close="closeDialog" :routeType="detailsType"
                       :detailsId="detailsId"></detailsDialog>

        <upgradeDevice v-if="upgradeDevice" :visible.sync="upgradeDevice" @close="closeDialog" :upgradeId="upgradeId"
                       :upgradeType="upgradeType"></upgradeDevice>
