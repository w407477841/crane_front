            ...
            <el-form :inline="true" class="condition-form">
              <el-row>
                <el-col :span="16" style="padding-bottom: 0px;">
                  <el-form-item>
                    <el-input size="mini" v-model="keyword" :disabled="edit" placeholder="角色编号/角色名称" :clearable="true"></el-input>
                  </el-form-item>
                  <el-form-item>
        ...
        <div class="container-box list-box">
          <el-row class="sysRole_box">
            ...
            <el-col class="sysRole_right" :span="8">
             <el-tree :data="data" :default-expand-all="true" :show-checkbox="true" node-key="id" :props="props" ref="tree" class="toolbar" style="overflow-y:scroll;max-height:92%;"></el-tree>
            </el-col>
          </el-row>
        </div>
      </div>
