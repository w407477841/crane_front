                            ...
                            <el-row>
                                ...
                                <el-col :xs="24" :sm="24" :md="24">
                                    ...
                                    <el-form-item label="厂家" prop="vender">
                                       <el-select v-model="formDatas.vender" filterable  clearable  :disabled="edit" placeholder="请选择">
                                            <el-option v-for="item in venders" :label="item.name" :value="item.name" :key="item.name"></el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
...
export default {
  ...
  computed: {
    ...
    params() {
      let param = {
        body: Object.assign({},this.formDatas,{
