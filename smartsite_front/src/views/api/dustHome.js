...
export const getWeatherApi = params => {
    return http.get('/project/projectEnvironmentMonitorDetail/getWeatherInfo', { params: params,loading:false }).then(res => {
        return res;
    });
}
...
export const getCraneDetail = params => {
    return http.post('/device/projectCrane/getCraneDetail',  params,{loading:false}).then(res => {
        return res;
    });
}
