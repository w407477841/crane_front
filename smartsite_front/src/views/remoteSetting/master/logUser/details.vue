                                ...
                                <el-row>
                                    <el-col :xs="24" :sm="24" :md="24">
                                        <el-form-item label="设备类型" prop="deviceType">
                                            <el-select v-model="formDatas.deviceType" filterable clearable :disabled="edit"
                                                       placeholder="请选择">
                                    ...
                                    <el-col :xs="24" :sm="24" :md="24">
                                        <el-form-item label="发送用户" prop="userIdList">
                                            <el-select v-model="formDatas.userIdList" multiple  :disabled="edit"
                                                       filterable allow-create default-first-option
                                                       placeholder="请选择发送用户">
                                                <el-option v-for="item in sendUsers" :label="item.name"
...
<script>
    import {getUserListApi,insertInfoApi,getInfoApi,updateInfoApi} from "@/views/remoteSetting/api/logUser.js";
    import {
