        ...
        <div class="container-box condition-box">
            <div class="conditionBar">
                <el-form :inline="true" class="condition-form">
                    ...
                    <el-form-item>
                        <el-input size="mini" placeholder="请输入设备编号" v-model="keyword" clearable
        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row
                    ...
                    <el-table-column label="SIM卡" prop="gprs" :formatter="handleSIM" show-overflow-tooltip></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSIM(row){
                console.log(row.gprs)
                 if(row.gprs == null || row.gprs ==""){
                     return "暂无";
                 }else{
                     return row.gprs;
                 }
