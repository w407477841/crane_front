                    ...
                    <el-tabs type="border-card" style="height:100%">
                        <el-tab-pane label="附件信息">
                            <uploadFile ref="filePane2" :disabled="edit" :fileList="annex" @data="listenToFile"
                                        :hide="false" :newHide="false">
                                <el-table-column prop="name" label="升级包名称" mini-width="120"></el-table-column>
                                <el-table-column prop="useType" label="类型" mini-width="120" :render-header="renderHeaderFunction">
                                    <template slot-scope="scope">
                                        <el-select v-model="scope.row.useType" filterable clearable :disabled="edit"
                               ...
                               <!-- <el-table-column prop="version" label="版本号" mini-width="120"  :render-header="renderHeaderFunction">
                                ...
                                <el-table-column prop="version" label="版本号" min-width="130" show-overflow-tooltip
                                                 :formatter="formatterVersion"></el-table-column>
                                <el-table-column prop="comments" label="备注" mini-width="120">
                                    <template slot-scope="scope">
                                        <el-input size="mini" v-model="scope.row.comments" :disabled="edit"
                                                  :maxlength="12"></el-input>
                                    </template>
                                </el-table-column>
                            </uploadFile>
