  ...
  <section>
    <el-row>
      <el-col :span="24" class="toolbar" style="padding-buttom : 0px">
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="addClick" :disabled="edit">新增</el-button>
        <el-button type="danger" icon="el-icon-delete" size="mini" :disabled="edit || selsdetails.length==0" @click="delClick">批量删除</el-button>
      </el-col>
    </el-row>
    <el-table size="small" :data="tableData"  tooltip-effect="dark" style="width: 100%" class="tb-edit" highlight-current-row @selection-change="selectionChange" :row-class-name="tableRowClassName">
      ...
      <el-table-column label="通道">
        <template slot-scope="scope">
          <el-input-number :precision="0" :max="999999999" v-model="scope.row.tunnel" :controls="false" :disabled="edit"></el-input-number>
        </template>
      </el-table-column>
     ...
     <el-table-column label="操作" width="120" align="center" fixed="right">
                   ...
                   <el-button type="danger" size="mini" icon="el-icon-delete" :disabled="edit" @click="delClickOne(scope.row)">删除</el-button>
                        </template>
      </el-table-column>
    </el-table>
  </section>
