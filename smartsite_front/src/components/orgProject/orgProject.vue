    ...
    <div class="list-container">
        <div class="container-box list-box">
            <div class="table-box">
                <el-row>
                    <el-col :span="8">
                        <el-tree :default-expand-all="true" ref="tree" :data="data" :props="defaultProps" @node-click="handleNodeClick"></el-tree>
                    </el-col>
                    <el-col :span="16">
                        <el-table size="small" ref="table" :data="listData" style="width: 100%" @row-click="getRow" highlight-current-row header-row-class-name="xyTableHeader">
                            ...
                            <el-table-column label="平台名称" prop="applicationName"></el-table-column>
...
<script>
import {selectOrganizationInfo,getPorject} from "@/views/api/equipmentApi.js";
export default {
    data() {
        return {
            listData: [],
