<template>
  ...
  <el-menu class="navbar" mode="horizontal">
    ...
    <hamburger v-if="device==='mobile'" class="hamburger-container" :toggleClick="toggleSideBar" :isActive="sidebar.opened"></hamburger>
    ...
    <div class="right-container">
      ...
      <template>
        <div class="project-container">
          ...
          <el-select class="projectselectBlur" size="small" v-model="orgId" filterable placeholder="请选择" popper-class="selectClass" @change="orgChange">
            <el-option  label="所有项目部" :value="topId">
            </el-option>
