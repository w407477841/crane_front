    ...
    <div class="container-box list-box">
      <div class="table-box">
        <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row @selection-change="listSelectionChange" header-row-class-name="xyTableHeader">
          ...
          <el-table-column label="运行时间" prop="collectTime" :formatter="getDate"></el-table-column>
...
export default {
  data() {
    return {
      ...
      beginDate: "",
      endDate: "",
      statusList: [{ label: "不受控", value: 0 }, { label: "受控", value: 1 }],
      percentage: "",
  ...
  mounted() {
      this.deviceNo = this.$route.query.row.imei;
