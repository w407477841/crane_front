        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%"  highlight-current-row @selection-change="listSelectionChange"  header-row-class-name="xyTableHeader">
                    ...
                    <el-table-column label="设备编号" width="150px" prop="deviceNo"></el-table-column>
                    ...
                    <el-table-column label="操作" width="400" align="center" fixed="right">
                        <template slot-scope="scope">
                            <rightButton  :disUpdate="scope.row.status=='1'?true:false" :disDelete="scope.row.status=='1'?true:false"  @clickView="handleView" @clickUpdate="handleUpdate" @clickDelate="handleDelete" :row="scope.row" :operationPrex="operationPrex">
  ...
  methods: {
    ...
    handleDispatch(row){
      ...
      this.$confirm("确认转发吗？", "提示", {
          ...
          row.needDispatch=1;
          updateLiftDispatch(params).then(res => {
            this.$message({
              message: res.message,
              type: res.success ? "success" : "error"
            });
