    ...
    <div class="container-box condition-box">
      <div class="conditionBar">
        <el-form :inline="true" class="condition-form">
          ...
          <topButton @clickInsert="handleInsert" @clickDelate="handleDelete" @clickBinding="handleBinding" :sels="sels" :hasBinding="true" :operationPrex="operationPrex" check="uuid=0"></topButton>
          <el-form-item>
