...
export default {
  ...
  methods: {
    ...
    goToMessageAlarm : function(row) {
      this.id = row.id;
      this.content = "工程名称：" + this.mainInfo.projectName + ",设备编号：" + this.mainInfo.deviceNo + ",总预警：" + row.alarmAll + ",重量预警：" + row.alarmWeight + ",幅度预警：" + row.alarmRange + ",力矩预警 ：" + row.alarmMoment + ",碰撞预警：" + row.alarmCollision;
