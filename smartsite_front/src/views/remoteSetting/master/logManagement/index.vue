...
<template>
    <div class="app-container list-container">
            ...
            <div class="conditionBar">
                <el-form :inline="true" class="condition-form">
                    <el-form-item label="" prop="type">
                        <el-select v-model="type" filterable clearable size="mini"
                                   placeholder="设备类型">
                    ...
                    <el-form-item>
                        <el-input size="mini" placeholder="项目名称/设备编号" v-model="keyword" clearable
                    ...
                    <el-form-item>
                        <el-button class="searchBtn" type="primary" size="mini" :disabled="editReboot"
                                   @click="handleDeviceReboot">设备重启
                        </el-button>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row
                    ...
                    <el-table-column label="设备编号" prop="deviceNo" show-overflow-tooltip></el-table-column>
                    <el-table-column label="版本号" prop="version"></el-table-column>
                    <el-table-column label="设置履历" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span style="text-decoration: underline;color:blue;"
                                  @click="handleSetLog(scope.row)">详情</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="异常日志履历" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span style="text-decoration: underline;color:blue;" @click="handleExceptionLog(scope.row)">详情</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="日志发送履历" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span style="text-decoration: underline;color:blue;"
                                  @click="handleExceptionSMSLog(scope.row)">详情</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="重启履历" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span style="text-decoration: underline;color:blue;"
                                  @click="handleRebootLog(scope.row)">详情</span>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
        ...
        <handleExceptionLog v-if="visibleExceptionLog" :visible.sync="visibleExceptionLog"
                            @close="closeDialog" :deviceType="deviceType" :projectIdVal="projectId"
                            :deviceNo="deviceNo"></handleExceptionLog>

        <handleExceptionSMSLog v-if="visibleExceptionSMSLog" :visible.sync="visibleExceptionSMSLog"
                               @close="closeDialog" :deviceType="deviceType" :projectIdVal="projectId"
                               :deviceNo="deviceNo"></handleExceptionSMSLog>

        <handleRebootLog v-if="visibleRebootLog" :visible.sync="visibleRebootLog"
                         @close="closeDialog" :deviceType="deviceType" :projectIdVal="projectId"
                         :deviceNo="deviceNo"></handleRebootLog>

        <handleSettingLog v-if="visHandleSettingLog" :visible.sync="visHandleSettingLog"
                         @close="closeDialog" :deviceType="deviceType" :projectIdVal="projectId"
                         :deviceNo="deviceNo"></handleSettingLog>
    </div>
</template>
<script>
    import {getListApi, deviceReboot} from "@/views/remoteSetting/api/logManagement.js";
    ...
    export default {
        components: {
            handleExceptionLog, handleExceptionSMSLog, handleRebootLog,handleSettingLog
        },
        data() {
            return {
